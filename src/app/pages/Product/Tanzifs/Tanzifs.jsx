...
export default function Tanzifs() {
    ...
    return (
        <aside className='products_block'>
                            ...
                            <div className='product_parametrs_flex'>
                                <div className='product_parametrs'>
                                    ...
                                    <div className='product_layer'>
                                        ...
                                        <span className='home_product_card_size_text'>{item.parametrs.sizeTwo.from} շերտ</span>
                                    </div>
                                    <div className='product_count'>
                                        ...
                                        <span className='home_product_card_size_text'>{item.parametrs.sizeTwo.to} հատ</span>
                                    </div>
                                </div>
                            </div>
