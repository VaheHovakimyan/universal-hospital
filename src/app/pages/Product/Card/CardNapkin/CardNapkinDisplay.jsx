...
export default function CardDisplay() {
    ...
    return (
        ...
        <div className='product_card_page_flex'>
            <div className='product_card_page'>

                <div className='product_card_page_img'>

                    <div className='card_sterile_part'>
                        {product_napkins[key].sterile ? <img src={sterile_image} alt="sterile_image" /> : <div className='sterile_img_for_null'></div>}
                    </div>
                ...
                <div className='product_card_page_text_div'>
                    <h1 className='product_card_page_title'>{product_napkins[key].name}</h1>
