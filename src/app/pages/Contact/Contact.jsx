        ...
        <div className='contact_main_elements'>
            ...
            <aside className='contact_right_part'>
                ...
                <div className='contact_right_part_contact_div'>
                    <input type="text" placeholder='Անուն' className='contact_right_part_input' />
                    <input type="text" placeholder='Էլ․հասցե' className='contact_right_part_input' />
                    <textarea name="message" id="message_textarea" cols="30" rows="10" placeholder='Հաղորդագրություն' className='contact_right_part_textarea'></textarea>
                </div>
                <button className='contact_right_part_snd_msg_button'>ՈՒՂԱՐԿԵԼ</button>
